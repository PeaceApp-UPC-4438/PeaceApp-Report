...
| **User Story ID** | EP05                                                                                                                                                                                                                                 | **Epic ID** | EP05 |
...
que la interfaz de la aplicación sea intuitiva y fácil de navegar,
...
mapa</strong></p>
<p><strong>Dado que</strong> el ciudadano está utilizando el mapa
...
en esa zona,</p>
<p><strong>Entonces</strong> la aplicación envía una alerta al
ciudadano.</p></td>
</tr>
<tr class="even">
<td><strong>User Story ID</strong></td>
...
su perfil,</p>
<p><strong>Cuando</strong> hay un problema de conectividad o error del
servidor,</p>
<p><strong>Entonces</strong> el sistema muestra un mensaje de error
...
<tr class="odd">
<td colspan="4"><p><strong>Acceptance Criteria:</strong></p>
<p><strong>Escenario 1: Actualizar nombre y correo del
perfil</strong></p>
...
está disponible</p>
<p><strong>Cuando</strong> se envía un GET request con el ID de una
región</p>
<p><strong>Entonces</strong> se recibe un response con un status 200</p>
<p><strong>Y</strong> el estado actual de la zona (segura, moderada,
peligrosa) es devuelto en el body del response.</p>
<p><strong>Escenario 2: Intentar obtener el estado de una zona
inexistente</strong></p>
<p><strong>Dado que</strong> el endpoint /api/v1/map/regions/{regionId}
está disponible</p>
<p><strong>Cuando</strong> se envía un GET request con un ID de región
inexistente</p>
<p><strong>Entonces</strong> se recibe un response con un status 404</p>
<p><strong>Y</strong> un mensaje en el body del response dice "Zona no
encontrada."</p></td>
</tr>
<tr class="even">
<td><strong>User Story ID</strong></td>
...
<tr class="odd">
<td><strong>Title</strong></td>
<td colspan="3">Enviar notificación a los usuarios mediante RESTful
API</td>
</tr>
<tr class="even">
<td><strong>Description</strong></td>
<td colspan="3"><strong>Como</strong> desarrollador,
<strong>quiero</strong> que los usuarios puedan recibir notificaciones
en la plataforma <strong>para</strong> que se encuentren informados en
tiempo real.</td>
</tr>
<tr class="odd">
<td colspan="4"><p><strong>Acceptance Criteria:</strong></p>
<p><strong>Escenario 1: Enviar notificación válida</strong></p>
<p><strong>Dado que</strong> el endpoint /api/v1/notifications está
disponible</p>
<p><strong>Cuando</strong> se envía un POST request con los datos del
evento importante</p>
<p><strong>Entonces</strong> se recibe un response con un status 201</p>
<p><strong>Y</strong> los usuarios reciben la notificación en la
plataforma con los detalles del evento.</p>
<p><strong>Escenario 2: Intentar enviar notificación sin datos
válidos</strong></p>
<p><strong>Dado que</strong> el endpoint /api/v1/notifications está
disponible</p>
<p><strong>Cuando</strong> se envía un POST request sin los datos
necesarios</p>
<p><strong>Entonces</strong> se recibe un response con un status 400</p>
<p><strong>Y</strong> un mensaje en el body del response dice "Datos
insuficientes para generar la notificación."</p></td>
</tr>
<tr class="even">
<td><strong>User Story ID</strong></td>
<td>TS14</td>
...
<tr class="odd">
<td><strong>Title</strong></td>
<td colspan="3">Obtener lista de notificaciones enviadas a los usuarios
mediante RESTful API</td>
</tr>
<tr class="even">
<td><strong>Description</strong></td>
<td colspan="3"><strong>Como</strong> desarrollador,
<strong>quiero</strong> que los usuarios puedan revisar las
notificaciones importantes que han recibido previamente
<strong>para</strong> consultar eventos pasados.</td>
</tr>
<tr class="odd">
<td colspan="4"><p><strong>Acceptance Criteria:</strong></p>
<p><strong>Escenario 1: Obtener lista de notificaciones</strong></p>
<p><strong>Dado que</strong> el endpoint /api/v1/notifications está
disponible</p>
<p><strong>Cuando</strong> se envía un GET request</p>
<p><strong>Entonces</strong> se recibe un response con un status 200</p>
<p><strong>Y</strong> una lista de las notificaciones recibidas es
devuelta en el body del response.</p>
<p><strong>Escenario 2: No hay notificaciones disponibles</strong></p>
<p><strong>Dado que</strong> el endpoint /api/v1/notifications está
disponible</p>
<p><strong>Cuando</strong> se envía un GET request</p>
<p><strong>Entonces</strong> se recibe un response con un status 200</p>
<p><strong>Y</strong> un mensaje en el body dice "No hay notificaciones
disponibles."</p></td>
</tr>
<tr class="even">
<td><strong>User Story ID</strong></td>
...
<tr class="odd">
<td><strong>Title</strong></td>
<td colspan="3">Eliminar notificación mediante RESTful API</td>
</tr>
<tr class="even">
<td><strong>Description</strong></td>
<td colspan="3"><strong>Como</strong> desarrollador,
<strong>quiero</strong> que los usuarios puedan eliminar las
notificaciones que ya no son relevantes <strong>para</strong> mantener
su bandeja de notificaciones organizada.</td>
</tr>
<tr class="odd">
<td colspan="4"><p><strong>Acceptance Criteria:</strong></p>
<p><strong>Escenario 1: Eliminar notificación existente</strong></p>
<p><strong>Dado que</strong> el endpoint /api/v1/notifications/{id} está
disponible</p>
<p><strong>Cuando</strong> se envía un DELETE request con el ID de la
notificación</p>
<p><strong>Entonces</strong> se recibe un response con un status 204</p>
<p><strong>Y</strong> la notificación es eliminada del sistema.</p>
<p><strong>Escenario 2: Intentar eliminar notificación
inexistente</strong></p>
<p><strong>Dado que</strong> el endpoint /api/v1/notifications/{id} está
disponible</p>
<p><strong>Cuando</strong> se envía un DELETE request con un ID
inexistente</p>
<p><strong>Entonces</strong> se recibe un response con un status 404</p>
<p><strong>Y</strong> un mensaje en el body dice "Notificación no
encontrada."</p></td>
</tr>
</tbody>
</table>
